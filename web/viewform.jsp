    ...
    <body>
        ...
        <div class="container mt-5 d-flex justify-content-center">
            ...
            <div class="card shadow custom-width">
                <div class="card-body">
                    <!-- Form starts here -->
                    <form class="needs-validation" action="genratepdf" method="POST" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="companyName" value="<%=company_name%>" name="companyName" placeholder="Enter Company Name" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="customerAddress"  name="customerAddress" rows="3" placeholder="Enter Customer Address" required><%=customer_address%></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="gstNo" value="<%=gst_no%>" name="gstNo" placeholder="GST No" pattern="[A-Za-z0-9]{15}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="mobileNo" value="<%=phone%>" name="mobileNo" placeholder="Enter Mobile No" pattern="\+91[0-9]{10}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="dueDate" value="<%=due_date%>" name="dueDate" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="currentDate" value="<%=created_date%>" name="currentDate" value="" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="<%=total_amount%>" name="total" id="total" placeholder="Enter Total Amount" required>
                            <div class="invalid-feedback">Please enter the total amount.</div>
                        </div>

                        <!-- Centered Submit Button -->
                        <div class="d-flex justify-content-center">
                            <button type="submit" name="action" value="Download PDF" class="btn btn-primary w-50">Download</button><br>
                            <button type="submit" name="action" value="Send Email" class="btn btn-primary w-50">Send Email</button>
                        </div>
                    </form>
                    <!-- Form ends here -->
                </div>
